...
1- We estimated the spatial distribution of species using the R package sdmTMB (Anderson et al. 2022; R Core Team 2023) instead of VAST (Thorson 2019). The sdmTMB models included Pass and scaled depth as fixed parameters. Year was a time variable and models included both spatial and spatiotemporal (iid) autocorrelation, and a delta-poisson-link-gamma error distribution (Thorson 2018) error distribution.

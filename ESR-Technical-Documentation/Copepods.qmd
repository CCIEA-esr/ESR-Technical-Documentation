...
```
 **Indicator Category** `r df_trimmed$Component_Section[1]`, `r df_trimmed$Subcomponent[1]`
 
 **Indicator ERDDAP ID** 'ERDDAP_Dataset_ID'
 
 **Data Steward** 'PI', 'Contact' 
 
 
 **Region** **ERDDAP_query_value** **ERDDAP_variable_name** **Source_Data** **Additional_Calculations**
